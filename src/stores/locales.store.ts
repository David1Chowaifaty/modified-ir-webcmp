...
export type LocalizationStrings = {
  ...
  'Lcz_City': string;
  'Lcz_CleaningFrequency': string;
  'Lcz_ClearningArchives': string;
  'Lcz_ClickToViewNote': string;
  'Lcz_Collected': string;
  'Lcz_Confirm': string;
  'Lcz_Confirmation': string;
  'Lcz_Confirmed': string;
  'Lcz_ConfirmUpdateStatus': string;
  ...
  'Lcz_HighlightCheck-insFrom': string;
  'Lcz_Hint': string;
  'Lcz_Housekeeper': string;
  'Lcz_HousekeeperName': string;
  'Lcz_Housekeepers': string;
  'Lcz_HouseKeepingAndCheckInSetup': string;
  ...
  'Lcz_NoIWillDoItManually': string;
  'Lcz_NonRefundable': string;
  'Lcz_NoPenalityIsAppliedIfCanceledNow': string;
  'Lcz_NoRatePlanDefined': string;
  'Lcz_NoResultsFound': string;
  'Lcz_NoTasksFound': string;
  ...
  'Lcz_WasVacant': string;
  'Lcz_Year': string;
  'Lcz_Years': string;
  'Lcz_YES': string;
  'Lcz_YesAsPerPropertyPolicy': string;
