              ...
              {this.users.map(user => {
                ...
                return (
                  <tr key={user.id} class="ir-table-row">
                    ...
                    <td>{new Date(user.last_sign_in).getFullYear() === 1900 || !user.last_sign_in ? 'N/A' : moment(user.last_sign_in, 'YYYY-MM-DD').format('MMM, DD YYYY')}</td>
                    <td>{new Date(user.created_on).getFullYear() === 1900 || !user.created_on ? 'N/A' : moment(user.created_on, 'YYYY-MM-DD').format('MMM, DD YYYY')}</td>
                    <td>{!isSuperAdmin && <ir-switch onCheckChange={e => this.handleUserActiveChange(e, user)} checked={user.is_active}></ir-switch>}</td>
                    <td>
