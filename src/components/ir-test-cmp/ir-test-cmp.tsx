        ...
        <section class="p-2">
          <div class="row g-3">
            <div class="col-md-3">
              ...
              <ir-m-combobox placeholder="Select an option..." dataMode="static" options={this.staticOptions} onOptionChange={this.handleStaticOptionChange}>
          ...
          {/* <ir-input-text variant="floating-label" class="my-text-input" label="First name" style={{ '--ir-floating-input-height': '4rem' }}>
            ...
            <svg slot="suffix" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
          ...
          <ir-dropdown value={'hello'} onOptionChange={e => {}}>
            <ir-button slot="trigger" text="Trigger"></ir-button>
            {this.staticOptions.map(option => (
              <ir-dropdown-item value={option.value}>{option.label}</ir-dropdown-item>
            ))}
            <div class={'dropdown-divider'}></div>
            <ir-dropdown-item value={'hello'}>Hello</ir-dropdown-item>
          </ir-dropdown>
        </section>
      </Host>
    );
