...
| `type`            | `type`             | Input type (e.g., text, password, email)                        | `"number" \| "color" \| "button" \| "time" \| "image" \| "text" \| "hidden" \| "search" \| "date" \| "email" \| "url" \| "week" \| "month" \| "reset" \| "submit" \| "password" \| "range" \| "file" \| "tel" \| "datetime-local" \| "checkbox" \| "radio"` | `'text'`    |
