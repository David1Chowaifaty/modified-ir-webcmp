...
| `type`                | `type`              | Input type (e.g., text, password, email)                               | `"number" \| "color" \| "button" \| "time" \| "image" \| "text" \| "hidden" \| "search" \| "file" \| "email" \| "date" \| "url" \| "week" \| "month" \| "password" \| "reset" \| "submit" \| "range" \| "tel" \| "datetime-local" \| "checkbox" \| "radio"` | `'text'`    |
