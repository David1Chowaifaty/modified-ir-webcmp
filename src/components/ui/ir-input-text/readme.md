...
| `type`                    | `type`                      | Input type (e.g., text, password, email)                                                                                                                                                                                                        | `"number" \| "color" \| "button" \| "time" \| "image" \| "text" \| "hidden" \| "search" \| "file" \| "email" \| "date" \| "url" \| "week" \| "month" \| "reset" \| "password" \| "submit" \| "range" \| "tel" \| "datetime-local" \| "checkbox" \| "radio"` | `'text'`    |
