...
export class IrPhoneInput {
  ...
  render() {
    return (
      ...
      //           <img src={this.currentCountry?.flag} class="flag" alt={this.currentCountry?.name} />
      ...
      // </Host>
      <div></div>
      // <ir-phone-combobox placeholder="Choose a fruit" options={this.countries.map(c => c.name)}></ir-phone-combobox>
    );
  }
}
