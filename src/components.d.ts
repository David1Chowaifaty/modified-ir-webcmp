...
import { Booking, ExtraService, IBookingPickupInfo, IOtaNotes, OtaService } from "./models/booking.dto";
...
export { Booking, ExtraService, IBookingPickupInfo, IOtaNotes, OtaService } from "./models/booking.dto";
